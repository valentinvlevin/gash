    ...
    {$REGION 'Выборка ранее оцененных результатов из БД'}
      begin
        ...
        FillDataSet(DM.fdQry,
          ...
          ' ocen1, ocen2, ocen3, ocen4, itog_ocen '+
          'from listotv '+
        ...
        begin
          ...
          begin
            arOcen[DM.fdQry.RecNo-1].Ord[PredmetIndex-1] :=
              DM.fdQry.FieldByName('ord'+IntToStr(PredmetIndex)).AsInteger;
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      arOcen[Index].Ord[PredmetIndex] := arListOtv[Index].Ord[PredmetIndex];
                    ...
                    DM.fdQry.ParamByName('ord'+IntToStr(PredmetIndex+1)).AsIntegers[ParamIndex] :=
                      arListOtv[Index].Ord[PredmetIndex];
